...
<html <?php language_attributes(); ?>>
    ...
    <head>
        <?php 
            if (function_exists('ps_012_m17n_bread_crumb')) 
            {
                ps_012_m17n_bread_crumb();
            }
        ?>
    ...
    <body <?php body_class(); ?>>
        ...
        <!-- ---------------- Top Header ------------------- -->
        <?php if (cyberchimps_get_option('top_header_bar', 1)): ?>
                ...
                <div class="container-fluid">
                    ...
                    if (function_exists('ps_012_multilingual_list')) {
                        ...
                        foreach ( array_reverse( $gs, true ) as $key => $val ) 
                        {
                            ...
                            $flag_icon_decolored = $flags_dir . $key . '_decolored.png';
                            if ( ps_url_exists( $flag_icon ) )
                            {
                                if ( $val['current'] ) 
                                {
                                    $flag_icon = '<img src="' . $flag_icon . '" class="selected">';
                                } 
                                else 
                                {
                                    $flag_icon = '<a href="' . $val['url'] . '"><img src="' . $flag_icon_decolored . '" class="notSelected"></a>';
                                }
                            }
                            $html .= $flag_icon . '&nbsp';
                        }
